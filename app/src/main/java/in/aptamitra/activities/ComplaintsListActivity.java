...
//            Log.d("complaints","sixe is:"+objects.size());
...
//                    .getLayoutInflater();
//            View row = inflater.inflate(R.layout.complaint_list_item, parent,
//                    false);
//            return  row;
////            try {
////                SharedPreferences prefs = activity.getSharedPreferences("cache", Context.MODE_PRIVATE);
...
////
////
////                JSONObject data = complaintsData.get(complaintsData.size()-1-position);
////
////                ((TextView) row.findViewById(R.id.complaint_title))
////                        .setText(data.getString("complaint_title"));
...
////
////
////                if(!data.getString("complaint_image").trim().contentEquals("")) {
////                    String url = StringDecoder.decode(data.getString("complaint_image"));
////
////                    ImageLoader imageLoader = ImageLoader.getInstance();
////                    DisplayImageOptions options = new DisplayImageOptions.Builder().cacheInMemory(true)
////                            .cacheOnDisc(true).resetViewBeforeLoading(true).build();
////                    ImageView imageView = (ImageView) row.findViewById(R.id.image_container);
////                    imageLoader.displayImage(url, imageView, options);
////                }
////                else
////                {
////                    ((ViewGroup)row).removeView((ImageView) row.findViewById(R.id.image_container));
////                }
////
////
////            } catch (Exception e) {
